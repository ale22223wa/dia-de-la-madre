    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <main class="flex flex-col lg:flex-row items-center justify-between gap-8 mb-16">
            ...
            <div class="relative w-64 h-80 mx-auto lg:mx-0 polaroid">
                <img id="momPhoto" src="https://images.unsplash.com/photo-1607748851687-ba3a70365e96?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
            ...
            <div class="max-w-lg message-box p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-700 mb-4">Hoy es tu día y quiero que sepas lo especial que eres para mí. Eres mi guía, mi apoyo y mi mayor inspiración. Gracias por tu amor incondicional, por tus sacrificios y por estar siempre ahí cuando te necesito.</p>
                <p class="text-gray-700 mb-4">Eres el corazón de nuestra familia y la luz que ilumina nuestros días. Hoy celebramos todo lo que eres y todo lo que haces por nosotros.</p>
                <p class="font-dancing text-xl text-pink-600">¡Te quiero mucho!</p>
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="floating" style="animation-delay: 0s;">
                    <img src="https://images.unsplash.com/photo-1529333164857-423483d1d267?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                ...
                <div class="floating" style="animation-delay: 0.2s;">
                    <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                ...
                <div class="floating" style="animation-delay: 0.4s;">
                    <img src="https://images.unsplash.com/photo-1560169907-76f01c46216c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                ...
                <div class="floating" style="animation-delay: 0.6s;">
                    <img src="https://images.unsplash.com/photo-1529631176507-4f9a7f3ad9f6?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
